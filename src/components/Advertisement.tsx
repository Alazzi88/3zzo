    ...
    <section className="relative mt-44 overflow-hidden rounded-full  bg-gradient-to-r from-orange-500 to-yellow-400 py-14 text-center text-white shadow-lg">
      <div className="container mx-auto px-6">
        ...
        <a
          ...
          className="inline-block rounded-full bg-white px-8 py-3 text-lg font-semibold text-orange-600 transition-transform transform hover:scale-110 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-orange-300"
        >
          تسوق الآن
        </a>
      </div>
